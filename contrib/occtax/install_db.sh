...
export PGPASSWORD=$user_pg_pass;psql -h $db_host -p $db_port -U $user_pg -d $db_name -f tmp/occtax.sql  &>> ../../var/log/install_occtax_schema.log
...
echo "--------------------" &>> ../../var/log/install_occtax_schema.log
echo "" &>> ../../var/log/install_occtax_schema.log
export PGPASSWORD=$user_pg_pass;psql -h $db_host -p $db_port -U $user_pg -d $db_name -f data/exports_occtax.sql  &>> ../../var/log/install_occtax_schema.log
...
if $add_sample_data
	...
	echo "--------------------" &>> ../../var/log/install_occtax_schema.log
	echo "" &>> ../../var/log/install_occtax_schema.log
	export PGPASSWORD=$user_pg_pass;psql -h $db_host -p $db_port -U $user_pg -d $db_name -f data/sample_data.sql  &>> ../../var/log/install_occtax_schema.log
fi
